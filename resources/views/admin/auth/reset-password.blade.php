...
<head>
    ...
    <title>{{ config('app.name') }} - {{ __('Admin Khôi Phục Mật Khẩu') }}</title>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    <h2 class="h2 text-center mb-4">{{ __('Khôi Phục Mật Khẩu') }}</h2>
                    ...
                    <form action="{{ route('admin.password.store') }}" method="POST" autocomplete="off" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" value="{{ old('email', $request->email) }}" class="form-control" autocomplete="off" />
                        ...
                        <div class="mb-2">
                            <label class="form-label">{{ __('Nhập lại mật khẩu mới') }}</label>
                            <div class="input-group input-group-flat">
                        ...
                        <div class="form-footer">
                            <button type="submit" class="btn btn-primary w-100">{{ __('Khôi phục mật khẩu') }}</button>
                        </div>
                    </form>
                </div>
            </div>
