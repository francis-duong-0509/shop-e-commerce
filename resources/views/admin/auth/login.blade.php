...
<head>
    ...
    <title>{{ config('app.name') }} - {{ __('Admin Đăng Nhập') }}</title>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    <h2 class="h2 text-center mb-4">{{ __('Đăng nhập Admin') }}</h2>
                    ...
                    <form action="{{ route('admin.login') }}" method="POST" autocomplete="off" novalidate>
                        ...
                        <div class="mb-2">
                            <label class="form-label">{{ __('Mật khẩu') }}
                                <span class="form-label-description">
                                    <a href="{{ route('admin.password.request') }}">{{ __('Quên mật khẩu?') }}</a>
                                </span>
                            </label>
                        ...
                        <div class="mb-2">
                            <label class="form-check">
                                ...
                                <span class="form-check-label">{{ __('Ghi nhớ tôi') }}</span>
                            </label>
                        </div>
