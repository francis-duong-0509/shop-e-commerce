        ...
        <div class="navbar-nav flex-row d-lg-none">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown"
                    ...
                    <span class="avatar avatar-sm" style="background-image: url({{ asset(Auth::guard('web')->user()->avatar) }})">
                    </span>
                    <div class="d-none d-xl-block ps-2">
                        <div>{{ Auth::guard('web')->user()->name }}</div>
                        <div class="mt-1 small text-secondary">{{ Auth::guard('web')->user()->email }}</div>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="" class="dropdown-item">{{ __('Thông tin cá nhân') }}</a>
...
<header class="navbar navbar-expand-md d-none d-lg-flex d-print-none">
    <div class="container-xl">
        ...
        <div class="nav-item dropdown">
            ...
            <span class="avatar avatar-sm" style="background-image: url({{ asset(Auth::guard('web')->user()->avatar) }})"></span>
            <div class="d-none d-xl-block ps-2">
                <div>{{ Auth::guard('web')->user()->name }}</div>
                <div class="mt-1 small text-secondary">{{ Auth::guard('web')->user()->email }}</div>
            </div>
