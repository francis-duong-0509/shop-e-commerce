...
echo -e "   Web: ${GREEN}http://localhost:${DOCKER_NGINX_PORT:-8200}${NC}"
echo -e "   Admin: ${GREEN}http://localhost:${DOCKER_NGINX_PORT:-8200}/admin${NC}"
echo -e "   phpMyAdmin: ${GREEN}http://localhost:${DOCKER_PHPMYADMIN_PORT:-8202}${NC}"
echo -e "   MailHog: ${GREEN}http://localhost:${DOCKER_MAILHOG_WEB_PORT:-8205}${NC}"
echo -e ""
echo -e "${BLUE}🔌 Direct connections:${NC}"
echo -e "   MySQL: ${GREEN}localhost:${DOCKER_MYSQL_PORT:-8201}${NC}"
